...
import { VALUES, SEO, COLORS } from "@/libs/allLib";

export const metadata: Metadata = {
  title: `Error 404 | ${VALUES.appShortName}`,
  description: `This is Error page of ${VALUES.appName}`,
  authors: SEO.author,
  ...
  return (
    <>
      <div className="relative min-h-screen flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-[530px] text-center z-10">
          <div className="mx-auto text-center mb-9">
            ...
            >
              ...
              <defs>
                ...
                >
                  <stop stopColor={COLORS.secondary} stopOpacity="0" />
          ...
          <h3 className="mb-4 text-3xl font-bold sm:text-4xl color-primary">
            {`Sorry, the page can't be found`}
          </h3>
          <p className="mb-10 text-base font-medium leading-relaxed text-body-color sm:text-lg sm:leading-relaxed color-primary">
            The page you were looking for appears to have been moved,
            deleted or does not exist.
          </p>
          <Link
            href="/"
            className="inline-block px-8 py-3 text-base font-bold duration-300 rounded-md bg-primary shadow-signUp hover:bg-white hover:text-primary md:px-9 lg:px-8 xl:px-9 color-secondary"
          >
            Back to Homepage
          </Link>
        </div>
        ...
        <div className="absolute right-0 top-0 z-0 hidden sm:block">
          <svg
            width="406"
            height="286"
            viewBox="0 0 406 286"
