...
class UI(QWidget):
    ...
    def __init__(this, *args, **kwargs):
        ...
        this.icon = QIcon("util/src/icon.png")

        super().__init__(*args, **kwargs)

        this.setWindowTitle("Text-to-Speech")
        this.setWindowIcon(this.icon)
        this.setStyleSheet(open("util/CSS/QWidget.css").read())
        ...
        this.textbox.setStyleSheet(open("util/CSS/QTextEdit.css").read())
        ...
        label_speed.setStyleSheet(open("util/CSS/QLabel.css").read())
        ...
        this.play.setStyleSheet(open("util/CSS/QPushButton.css").read())
        ...
        label_save.setStyleSheet(open("util/CSS/QLabel.css").read())
        ...
        this.save_loc_box.setStyleSheet(open("util/CSS/QLineEdit.css").read())
        ...
        this.choose_directory.setStyleSheet(open("util/CSS/choose_dir.css").read())
    ...
    def __menubar_setup(this):
        ...
        this.menubar.setFont(this.font_menubar)
        this.menubar.setStyleSheet(open("util/CSS/QMenuBar.css").read())
    ...
    def __message_display(this, title: str, messsage: str):
        ...
        qm.setText(messsage)
        qm.setStyleSheet(open("util/CSS/QMessageBox.css").read())
        qm.exec()
